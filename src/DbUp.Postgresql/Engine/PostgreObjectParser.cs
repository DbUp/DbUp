...
{
    public class PostgreObjectParser
    {
        /// <summary>
        /// Quotes the name of the Postgre object in square brackets to allow Special characters in the object name.
        /// </summary>
        ...
        public static string QuoteSqlObjectName(string objectName, ObjectNameOptions objectNameOptions)
        {
            ...
            return string.Concat("\"", objectName, "\"");
        }
    }
}
