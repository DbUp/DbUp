...
{
    public class AzureSqlDwObjectParserTests
    {
        private readonly AzureSqlDwServerObjectParser sut;

        public AzureSqlDwObjectParserTests()
        {
            sut = new AzureSqlDwServerObjectParser();
        }
